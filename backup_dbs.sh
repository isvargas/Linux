#!/bin/bash
#Script para realizar o backup de varios banco de dados PostgreSQL e gravar em um arqivo ZIP.
...
#  usuario alem de vc tenha permissao de ler o conteudo e descobrir suas senhas :).
#
